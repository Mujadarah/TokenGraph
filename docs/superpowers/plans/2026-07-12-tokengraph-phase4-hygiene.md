...
- [x] **Step 3: Set truthful annotations**
...
- [x] **Step 3: Document and validate every registration**
...
- [x] **Step 4: Regenerate release docs and verify**
...
- [x] **Step 3: Implement project-wide retention and package-file scanning**
...
- [x] **Step 3: Implement the corrections**
...
```powershell
git diff --name-only codex/tokengraph-phase3-sql-scanning...HEAD | Where-Object { $_ -notlike 'release/tokengraph/dist/*' } | ForEach-Object { if (Select-String -LiteralPath $_ -Pattern '[^\\x00-\\x7F]' -Quiet) { throw "non-ASCII: $_" } }
```

- [x] **Step 3: Push and open the Phase 4 PR**
