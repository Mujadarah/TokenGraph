...
import { clearProjectIndex, clearProjectState, getWikiStatus, loadProjectIndex, loadProjectWiki, memoryPath, rulesPath, saveProjectIndex, saveProjectWiki } from "./core/persistence.js";
...
export function createTokenGraphServer(options = {}) {
    ...
    server.registerTool("tokengraph_index_project", {
        ...
        if (config.wikiGenerationEnabled) {
            try {
                ...
                wikiWarning = `Wiki refresh failed: ${error.message}`;
            }
        }
        return ok({
            status: "indexed",
    ...
    server.registerTool("tokengraph_index_status", {
        title: "Index Status",
    ...
    server.registerTool("tokengraph_reset_project", {
    ...
    server.registerTool("tokengraph_get_config", {
    ...
    server.registerTool("tokengraph_set_profile", {
    ...
    server.registerTool("tokengraph_update_config", {
    ...
    server.registerTool("tokengraph_list_rules", {
    ...
    server.registerTool("tokengraph_add_rule", {
    ...
    server.registerTool("tokengraph_update_rule", {
    ...
    server.registerTool("tokengraph_delete_rule", {
    ...
    server.registerTool("tokengraph_generate_wiki", {
    ...
    server.registerTool("tokengraph_show_wiki_page", {
    ...
    server.registerTool("tokengraph_compress_output", {
    ...
    server.registerTool("tokengraph_compress_context", {
        ...
        return ok(await compressContext({
            root: resolvedRoot,
            task,
            contentKind,
            text,
    ...
    server.registerTool("tokengraph_remember_decision", {
    ...
    server.registerTool("tokengraph_update_memory", {
        title: "Update Memory",
    ...
    server.registerTool("tokengraph_delete_memory", {
        title: "Delete Memory",
    ...
    server.registerTool("tokengraph_deprecate_memory", {
    ...
    server.registerTool("tokengraph_confirm_memory", {
    ...
    server.registerTool("tokengraph_find_memory_conflicts", {
    ...
    server.registerTool("tokengraph_link_memory", {
        title: "Link Memory",
    ...
    server.registerTool("tokengraph_review_memories", {
